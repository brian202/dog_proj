...
<%
	...
	try{
	    ...
	    String sql="select * from pet.product where product_desc = '영양제'";
...
<!--             </div> -->
            <div class="category_filter" style="float: left; width: 15%">
				<ul class="nav">
					...
					<li><a href="../category/category_food_plus.jsp"><span class="cat_name active-color">영양제</span></a></li>
					<li><a href="../category/category_shampoo.jsp"><span class="cat_name">샴푸</span></a></li>
					<li><a href="../category/category_cloths.jsp"><span class="cat_name">의류</span></a></li>
...
<form id = "sub_form" action = "../detail/detailpage.jsp" method = "get">
            <div class="category_content" style = "float : left; width : 20%">
                <table class="category_area"><input type = "hidden" name = "p_url" value = <%=p_url %>>
                    <tr class="cat_list">
                        <td class="cat_img" name = "p_url">
                        	<input type = "IMAGE" src=<%=p_url%> name = "p_url" value = <%=p_url %>>
                        </td>

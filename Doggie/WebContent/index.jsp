    ...
    <div id="fullpage">
      ...
      <div class="section sec1">
        ...
        <nav>
          ...
          <div class="header_tools">
            ...
            <a href="login/loginForm.jsp" class="login">login</a>
      ...
      <div class="section sec2 block">
        <div class="category_filter">
          ...
          <a href="main_change/index4.jsp" class="cat_name clothes">의류</a>
          <a href="main_change/index5.jsp" class="cat_name toy">장난감</a>
        </div>
        
        
<form action = "detail/detailpage.jsp" method = "post" onchange="formChange(this.form)">        
<%
	    while(rs.next()){

...
<%
	...
	try{
	    ...
	    String sql="select * from pet.product where product_desc='영양제' order by rand() LIMIT 5";
...
<!--       </div> -->
      ...
      <div class="section sec2 block">
        <div class="category_filter">
          ...
          <a href="../index.jsp" class="cat_name pet_food">사료</a>
          <a href="index2.jsp" class="cat_name bone">간식</a>
          <a href="index3.jsp" class="cat_name pills">영양제</a>
          <a href="index4.jsp" class="cat_name clothes">의류</a>
          <a href="index5.jsp" class="cat_name toy">장난감</a>
        </div>
